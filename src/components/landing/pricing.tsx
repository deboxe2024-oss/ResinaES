      ...
      <div className="container mx-auto px-4 text-center">
        ...
        >
            ...
            <div className="p-8 relative">
                ...
                <div className="mt-6">
                  <Button asChild className="h-14 w-full px-8 text-lg font-bold text-white bg-green-500 hover:bg-green-600 rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300">
